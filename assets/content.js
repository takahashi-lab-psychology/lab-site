...
const CONTENT = {
  ...
  news: [
    ...
    { date:"2026-09-10",
      text:{ ja:"研究協力者として関わった文部科学省委託事業「発達障害のある児童生徒等の不登校未然防止に資する校内支援体制のあり方についての調査」の報告書および好事例集が、文部科学省ホームページで公開されました。",
             en:"A report and a collection of good practices from a MEXT-commissioned study on school-based support systems for preventing school absenteeism among children with developmental disabilities have been published on the MEXT website. Prof. Takahashi took part in the study as a research collaborator." },
      url: "https://www.mext.go.jp/a_menu/shotou/tokubetu/main/006/r07/1420870_00013.htm" },
